...
default_nodes = pd.DataFrame([
    {"Node_ID": 1, "X": 0.0, "Y": 0.0, "Has_Rot_Spring": "Yes", "K_theta": 10.0, "Has_Vert_Spring": "No", "K_y": 0.0, "Active": "Yes"},
    {"Node_ID": 2, "X": 1.0, "Y": 0.0, "Has_Rot_Spring": "No", "K_theta": 0.0, "Has_Vert_Spring": "No", "K_y": 0.0, "Active": "Yes"},
])
...
default_loads = pd.DataFrame([
    {"Load_ID": 1, "Target_Type": "Node", "Target_ID": 2, "Has_Load": "Yes", "Load_Type": "Force", "Dir_X": -1, "Dir_Y": 0, "Active": "Yes"}
])
